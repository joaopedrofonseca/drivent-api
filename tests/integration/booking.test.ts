...
import { createEnrollmentWithAddress, createHotel, createRoomWithHotelId, createTicket, createTicketType, createTicketTypeNotIncludesHotel, createTicketTypeRemote, createTicketTypeWithHotel, createUser } from '../factories';
...
describe('PUT /booking/:bookingId', () => {
    ...
    describe('when token is valid', () => {
        it('should respond with status 403 when ticket type is remote', () => {

        });

        it('should respond with status 403 when ticket does not include hotel', () => {

        });

        it('should respond with status 403 when ticket status is not paid', () => {

        });

        it('should respond with status 404 when room not exists', () => {

        });

        it('should respond with status 403 when room is full of capacity', () => {

        });

        it('should respond with status 200 when user creates a booking', () => {
